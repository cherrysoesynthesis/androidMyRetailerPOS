...
//    public static Integer billFontSize = 16;
    ...
    public static String ZReadNoFormat = "";
...
//    }
    ...
    public static String dateYMD = "MM/dd/yyyy";
    public static String dateYYYY = "yyyy";
    public static String dateMM = "MM";
    public static String datedd = "dd";
...
//    public static String dateYMD_format2 = "yyyy-MM-dd";
    ...
    public static String VERSION_NAME = "3.3.27.7";
...
//    public static String ReceiptEditorActivity = "ReceiptEditorActivity";
    ...
    public static String TOUCH_AND_GO = "TOUCH";
