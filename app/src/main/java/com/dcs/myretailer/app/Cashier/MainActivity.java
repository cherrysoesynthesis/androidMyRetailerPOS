...
//    public static String category_checking = "0";
    ...
    public static Integer deleteCount = 0;
...
//        binding.container.setOnTouchListener(this);
        ...
        Integer chkCloseDt = Query.ZClosingCheckForYesterday();
        if (chkCloseDt != null && chkCloseDt == 1){
            Intent iReportActivity = new Intent(this, ReportActivity.class);
            iReportActivity.putExtra("statusZ",String.valueOf(chkCloseDt));
            startActivity(iReportActivity);
        }
...
//            PRODUCT_DX8000
        ...
        if (terminal_type.toUpperCase().equals(Constraints.INGENICO)){
            //new IngenicoInitialize(appContext);
            DeviceHelper.me().init(appContext);
