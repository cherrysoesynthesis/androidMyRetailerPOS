...
public class FileFormat_1 {
    public FileFormat_1(Context context, String billno, String fromDate, String toDate) {
...
//        String str1 = "D78000262022032500000000.00";//1-	CapitalLand
        ...
        if (c != null) {
            ...
            while (c.moveToNext()) {
                ...
                String salesSQL = "select SUM(TotalNettSales) " +
                ...
                if (cSalesSQL != null) {
                    if (cSalesSQL.getCount() != 0) {
                        if (cSalesSQL.moveToNext()) {
                            salesAmt = String.format("%.2f", cSalesSQL.getDouble(0));//3.00
                            ...
                            //getFTPFileFormat
                            FPTFileCreateActivity.writeGeneratedFile(context,fileName,str1);
