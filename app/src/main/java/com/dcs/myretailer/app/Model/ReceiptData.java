...
public class ReceiptData {
    ...
    public String statusCancelBill;
    public String statusVoidBill;
    String statusRefundBill;
    public String statusReprintBill;
    String QueueNo;
    String TableNo;
    String OrderStatus;
    String InvoiceNo;
    ...
    public ArrayList<BillPaymentValue> getBillPaymentDetailsValue() {
        return billPaymentDetailsValue;
    }

    public void setBillPaymentDetailsValue(ArrayList<BillPaymentValue> billPaymentDetailsValue) {
