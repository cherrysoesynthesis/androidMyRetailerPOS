...
//            btn_add_category.setWidth(px);
            ...
            linearbtnDeleteCategory.topMargin = 30;
...
//                            ViewGroup.LayoutParams.WRAP_CONTENT);
                    LinearLayout.LayoutParams LayBtnId = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
                    LayBtnId.topMargin = 20;
                    binding.LayBtnId.setLayoutParams(LayBtnId);

                    LinearLayout.LayoutParams linearBtn = new LinearLayout.LayoutParams(290, 100);
//                    linearBtn.bottomMargin = 20;
                    linearBtn.leftMargin = 20;
//                    linearBtn.topMargin = 20;
                    binding.btnAddCategory.setLayoutParams(linearBtn);
                    binding.btnDeleteCategory.setLayoutParams(linearBtn);
                }
