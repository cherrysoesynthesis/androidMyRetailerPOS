...
//    }
    ...
    private PrinterTester() {
//        if (TransactionDetailsActivity.sales_id > 0){
//            printer = TransactionDetailsActivity.getDal().getPrinter();
//        }else if (ReportActivity.date_status.equals("1")){
//            printer = ReportActivity.getDal().getPrinter();
//        }else if (CheckOutActivity.status.equals("1")){
//            printer = CheckOutActivity.getDal().getPrinter();
//        }else if (MainActivity.status.equals("1")){
//            //printer = MainActivity.getDal().getPrinter();
//
//            printer = MainActivity.getDal(MainActivity.getContext()).getPrinter();
//        }else {
//            Log.i("arrived_heredal__","_printertester");
//            printer = CashLayoutActivity.getDal(CashLayoutActivity.context).getPrinter();
//        }
        printer = DemoApp.getDal().getPrinter();
    }
...
//        }
        ...
        try {
            ...
            e.printStackTrace();
            logErr("init_exception", e.toString());
        }
    }
...
//             fontSet((EFontTypeAscii) EFontTypeAscii.FONT_16_32, (EFontTypeExtCode) EFontTypeExtCode.FONT_16_32);

//            printer.fontSet((EFontTypeAscii) EFontTypeAscii.FONT_16_32, (EFontTypeExtCode) EFontTypeExtCode.FONT_24_24);
//             printer.fontSet((EFontTypeAscii) EFontTypeAscii.FONT_24_24, (EFontTypeExtCode) EFontTypeExtCode.FONT_24_24);
            logTrue("fontSet");
        } catch (PrinterDevException e) {
            e.printStackTrace();
    ...
    public void printStr(String str, String charset) {
        try {
            ...
            Log.i("DfD_printertestcash__","str_"+str);
        } catch (PrinterDevException e) {
            e.printStackTrace();
            logErr("printStr", e.toString());

            Log.i("DfD_printertestcash__","ee_"+e.getMessage());
        }
