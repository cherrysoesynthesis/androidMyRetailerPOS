...
class ReportOtherPaymentAdapter extends BaseAdapter {
    Context context;
    ...
    public ReportOtherPaymentAdapter(Context applicationContext, String[] reportProductNameList, String[] reportProductPriceList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.activity_report_other_payment_listview, null);
