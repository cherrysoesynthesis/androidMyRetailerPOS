...
import com.dcs.myretailer.app.ScreenSize.ReportXFragmentScreenSize;
...
//        ReportActivity.previous_report_shift_name = "Now";
        ...
        //ScreenSize
        new ReportXFragmentScreenSize(mcontext,binding);
...
//            customAdapter.notifyDataSetInvalidated();
    ...
    public static void getPrintSales(String start, String end) {
        ...
        String sql = "SELECT Sales,Category,ProductSales,Payment,Discount,Tax,Cancellation," +
                "ReferInfoSales,Refund FROM ReportSettings";
        //Log.i("_sql__",sql);
