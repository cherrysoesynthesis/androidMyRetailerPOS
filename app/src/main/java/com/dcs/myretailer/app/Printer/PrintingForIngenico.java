...
public class PrintingForIngenico {
    ...
    public PrintingForIngenico(Context mcontext,String str) {
        //startPrinter(1,mcontext);
        //Log.i("dsfher__)","infenivo___"+MainActivity.receiptCount+"instr____"+str);
        //for (int printcount = 0; printcount < (MainActivity.receiptCount); printcount++) {
//        if (MainActivity.receiptCount > 1) {
//
//        }

            try {
                Log.i("SDFDException", "DException" + "one");
//                new IngenicoInitialize(CashLayoutActivity.context);
                Log.i("SDFDException", "DException" + "two");
//                UPrinter printer = DeviceHelper.me().getPrinter();

                Log.i("SDFDException", "DException" + "three");
               ...
               // if (MainActivity.receiptCount > 1) {
                    ...
                    startPrinter(0, mcontext, printingValue);
               // }
            } catch (Exception e) {
                e.printStackTrace();
                Log.i("SDFDException", "DException" + "INGEExceptionICO_" + e.getMessage());
            }
//        }
    }
...
//                                    UPrinter printer1) throws RemoteException {
...
//        printer.addText(AlignMode.CENTER, "Sheet number " + curSheetNo);
        //UPrinter printer = DeviceHelper.me().getPrinter();
        UPrinter printer = MainActivity.printer;
...
//        Log.i("str_____","str_LEFT_"+str);
//        printer.addText(AlignMode.LEFT, "Dsfee");
...
//
        ...
        printer.startPrint(new OnPrintListener() {
            ...
            public void onFinish() throws RemoteException {
                Log.i("Printing_","OnFinish");
            }

            @Override
            public void onError(int i) throws RemoteException {
                Log.i("Printing_","onError");
            }

            @Override
            public IBinder asBinder() {
                Log.i("Printing_","asBinder"+"str_LEFT__"+str);
                return null;
            }
        });
