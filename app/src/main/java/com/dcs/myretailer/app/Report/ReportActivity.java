        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_cashier:
                    ...
                    ReportActivity.previousReport = 0; //Added By Version 27
                    ReportActivity.previous_report_shift_name = "Now";//Added By Version 27
...
//        ReportXFragment.customAdapter.notifyDataSetChanged();
    ...
    public static void updateQtyAndAmtFun() {
        Log.i("Dsf____","Step1__"+ReportActivity.previous_report_shift_name);
...
//        previous_report_shift_name = "Now";
...
//        ReportActivity.previous_report_shift_name = "Now";
        Log.i("Dsf____","Step1_1_"+ReportActivity.previous_report_shift_name);
        updateReportDateAndDataFun();
...
//            dlg.show();
        ...
        Integer gapDate = Query.getGapDateForAutoBackDB();
