...
import com.dcs.myretailer.app.ScreenSize.MallInterfaceActivityScreenSize;
import com.dcs.myretailer.app.databinding.ActivityMallInterfaceBinding;

import java.util.ArrayList;
import java.util.List;

public class MallInterfaceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static Drawable visibleImg;
    public static Drawable inVisibleImg;
    public static String imageHideShowVar = "1";
    @Override
...
//        binding.ftpSyncBtn.setOnClickListener(this);
        binding.testConnection.setOnClickListener(this);

        //ScreenSize
        new MallInterfaceActivityScreenSize(this,binding);
    }
...
//        Log.i("doFun___","ftoDateValue____"+toDateValue);
        Log.i("doFun___","stst____"+ imageHideShowVar);
...
//        myAdapter.notifyDataSetChanged();
    ...
    public static void doFTPSync(Context context,String billno,String fromDate,String toDate,String status) {
        ...
        if (ftpSyncMallInterface.equals("1")) {
            new FTPFileCreate(context, billno, fromDate, toDate,status);
        }
    }
