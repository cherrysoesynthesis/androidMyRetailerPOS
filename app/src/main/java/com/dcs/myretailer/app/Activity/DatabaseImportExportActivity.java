...
import com.dcs.myretailer.app.ScreenSize.DatabaseImportExportActivityScreenSize;
import com.dcs.myretailer.app.Setting.MasterDatabaseAdapter;
...
public class DatabaseImportExportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ScreenSize
        new DatabaseImportExportActivityScreenSize(context,binding);
    ...
    private class CheckRepair extends AsyncTask<Object, Object, Integer> {
        ...
        protected Integer doInBackground(Object... params) {
            ...
            try {
                ...
                if(importdb.isEmpty()){
                    SQLiteDatabase dbcheck = SQLiteDatabase.openOrCreateDatabase(context.getDatabasePath("tmp_check.db").getAbsolutePath(),Constraints.encrypt_password, null);
