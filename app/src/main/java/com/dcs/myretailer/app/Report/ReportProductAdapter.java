...
public class ReportProductAdapter extends BaseAdapter {
    ...
    ArrayList<String> reportProductQtyArr;
    ArrayList<String> reportProductPriceArr;
    int flags[];
    LayoutInflater inflter;

    public ReportProductAdapter(Context applicationContext, ArrayList<String> reportProductNameArr, ArrayList<String> reportProductQtyArr, ArrayList<String> reportProductPriceArr) {
        this.context = context;
        this.reportProductNameArr = reportProductNameArr;
        this.reportProductQtyArr = reportProductQtyArr;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.activity_report_product_listview, null);
        ...
        try {
            report_product_quantity.setText("Quantity : "+reportProductQtyArr.get(i));
        } catch (IndexOutOfBoundsException e) {

        }
        try {
        if (reportProductPriceArr.get(i) != null && Double.valueOf(String.valueOf(reportProductPriceArr.get(i))) > 0.0) {
            report_product_price.setText("$" + String.format("%.2f", Double.valueOf(String.valueOf(reportProductPriceArr.get(i)))));
        }else {
