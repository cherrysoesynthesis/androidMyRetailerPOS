...
public class RecyclerviewItemBindingImpl extends RecyclerviewItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.layout_card_view, 2);
        sViewsWithIds.put(R.id.category_image, 3);
        sViewsWithIds.put(R.id.category_text, 4);
        sViewsWithIds.put(R.id.dropdownmark, 5);
    }
    // views
    // variables
    // values
