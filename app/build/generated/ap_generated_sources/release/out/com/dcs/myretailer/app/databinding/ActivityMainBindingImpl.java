...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.linearLayCheckoutBtn, 3);
        sViewsWithIds.put(R.id.btn_checkout, 4);
        sViewsWithIds.put(R.id.mainlayout, 5);
        sViewsWithIds.put(R.id.nav_view, 6);
        sViewsWithIds.put(R.id.edittext_barcode, 7);
    }
    // views
    // variables
    // values
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.dcs.myretailer.app.MainActivityViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.dcs.myretailer.app.MainActivityViewModel Viewmodel) {
